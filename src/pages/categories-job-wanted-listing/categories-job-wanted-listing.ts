...
/**
 * Generated class for the CategoriesJobWantedListingPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */

@IonicPage({ name: "CategoriesJobWantedListingPage" })
@Component({
  selector: "page-categories-job-wanted-listing",
  templateUrl: "categories-job-wanted-listing.html"
})
export class CategoriesJobWantedListingPage implements OnInit {
  categories_list: any = {};
  class_style: any;
  set_style_value: any;
  wanted_jobs = {};
